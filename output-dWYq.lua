	...
	if windowInfo.UseKey == true then
		confirm.MouseButton1Click:Connect(function()
			if key.Text == windowInfo.Key then
				...
				sub:TweenPosition(UDim2.new(0.51, 0, 0.5, 0), Enum.EasingDirection.InOut, Enum.EasingStyle.Linear, 0.25)
				task.wait(0.25)
				sub:TweenPosition(UDim2.new(0.49, 0, 0.5, 0), Enum.EasingDirection.InOut, Enum.EasingStyle.Linear, 0.25)
				task.wait(0.25)
				sub:TweenPosition(UDim2.new(0.51, 0, 0.5, 0), Enum.EasingDirection.InOut, Enum.EasingStyle.Linear, 0.25)
				task.wait(0.25)
				sub:TweenPosition(UDim2.new(0.49, 0, 0.5, 0), Enum.EasingDirection.InOut, Enum.EasingStyle.Linear, 0.25)
