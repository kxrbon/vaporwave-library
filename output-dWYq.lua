...
--[[
		...
		function category:AddSlider(sliderInfo)
			...
			move.MouseButton1Down:Connect(function()
				...
				move.Size = UDim2.new(0, math.clamp(mouse.X - move.AbsolutePosition.X, 0, sliderSlider.AbsoluteSize.X), 1, 0)
			...
			resetButton.MouseButton1Click:Connect(function()
				...
				move.Size = UDim2.new(0, math.clamp(mouse.X - move.AbsolutePosition.X, 0, move.AbsoluteSize.X), 1, 0)
				sliderInfo.Callback(Value)
			end)
		end
